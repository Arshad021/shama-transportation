...
export default function ToyotaCoaster22SeaterPage() {
  const vehicle = {
    title: "22-Seater Minibus (Toyota Coaster)",
    description:
      "The Toyota Coaster 22-Seater is ideal for group travel, school trips, tourism, staff transport, and corporate events. Enjoy a comfortable, spacious, and smooth journey across the UAE.",
    pax: 22,
    luggage: 20,
    features: [
      "Comfortable seating for 22 passengers",
      "Powerful dual AC system",
      "High-roof for extra headroom",
      "Smooth suspension",
      "Perfect for long-distance travel",
      "Professional, licensed driver included",
      "Large luggage storage",
      "Reliable for staff, school, and group transport",
    ],
