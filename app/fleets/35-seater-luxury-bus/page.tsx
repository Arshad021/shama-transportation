...
export default function LuxuryBus35SeaterPage() {
  const vehicle = {
    title: "35-Seater Luxury Bus",
    description:
      "Our 35-Seater Luxury Bus is perfect for corporate groups, tourism, event transport, weddings, and long-distance trips. Experience premium comfort, large seating, and smooth travel across the UAE.",
    pax: 35,
    luggage: 25,
    features: [
      "Spacious and comfortable seating for 35 passengers",
      "Powerful dual AC system for maximum cooling",
      "High-roof premium interior",
      "Smooth suspension for long-distance travel",
      "Ideal for corporate staff transport",
      "Professional and licensed driver included",
      "Large under-body luggage compartments",
      "Great for tourism, events, and airport transfers",
    ],
    image: "/images/35_SEATER_LUXURY_BUS-removebg-preview (1).png", // update to your image path
  };
